...
#                                  TRUE ~ hgnc_symbol))
anno <- readRDS("/Users/jgillard/Desktop/BERT study/BERT_analysis/20210312_ensembl_annotation.rds") # Annotation retrieved on 20210312

tmodBTMs <- readRDS("/Users/jgillard/Desktop/GSEAtmodDataV.0.40.rds") # Blood transcription modules extracted from tmod
...
RNAseq_coldata <- readRDS("/Users/jgillard/Desktop/RNAseq_coldata.rds")
...
# NL Gene scores
cts.NL <- read.csv("/Users/jgillard/Desktop/BERT study/BERT_analysis/exported data for manuscript/GSE195625_raw_gene_counts.csv", header = TRUE) %>%
  select(-1)
...
# Ox gene scores
cts.UK <- read.csv("/Users/jgillard/Desktop/BERT study/BERT_analysis/exported data for manuscript/GSE233855_Oxford_raw_gene_counts.csv") %>%
  mutate(ensembl_gene = str_split(Geneid, pattern = "[.]", simplify=T)[,1]) %>% # Strip off the version numbers for use with Biomart https://www.biostars.org/p/302441/
...
cts.tdap <- read.table(file = '/Users/jgillard/Desktop/BERT study/BERT_analysis/scRNAseq/Other data/GSE152683_ALL_HtSeq_counts.tsv', sep = '\t', header = TRUE) %>% # Raw HTSeq Counts, the authors TPM normalized afterwards. Generated from PBMCs
  data.frame() %>%
